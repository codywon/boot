...
gl-inet:	export MAX_UBOOT_SIZE=123
...
tplink_wr703n:	export MAX_UBOOT_SIZE=123
...
tplink_wr720n:	export UBOOT_FILE_NAME=uboot_for_tp-link_tl-wr720n_v3_CH
tplink_wr720n:	export MAX_UBOOT_SIZE=123
tplink_wr720n:	export COMPRESSED_UBOOT=1
tplink_wr720n:
