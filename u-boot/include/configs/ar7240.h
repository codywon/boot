...
#define CONFIG_AUTOBOOT_PROMPT		"Autobooting in:\t%d s (type 'cody' to run U-Boot console)\n\n"
#define CONFIG_AUTOBOOT_STOP_STR	"cody"
...
#define	CFG_PROMPT			"cody> "										/* Monitor Command Prompt    */
